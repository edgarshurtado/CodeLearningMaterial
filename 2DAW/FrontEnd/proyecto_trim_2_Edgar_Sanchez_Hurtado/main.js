window.onload = function (){
    ...
    $("#t_francia").mouseenter(changeWinnerImg("froome.jpg"));
    $("#g_italia").mouseenter(changeWinnerImg("contador.jpg"));
    $("#v_espana").mouseenter(changeWinnerImg("aru.jpg"));
...
function changeWinnerImg(imgSrc){
    return function(){
        var imgHolder = $("#winner_photo");
        imgHolder.fadeOut("fast", function(){
           imgHolder.attr("src", "./img/winners/" + imgSrc)
